...
class RecipeDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerNib(UINib(nibName: "IngredientCellOfRecipeDetail", bundle: nil), forCellReuseIdentifier: "IngredientCellOfRecipeDetail")
...
extension RecipeDetailViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("IngredientCellOfRecipeDetail", forIndexPath: indexPath) as! IngredientCellOfRecipeDetail
